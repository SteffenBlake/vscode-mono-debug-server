	...
	internal class Program
	{
		...
		private static void Main(string[] argv)
		{
			...
			if (port > 0) {
				...
				RunSession(System.Console.OpenStandardInput(), System.Console.OpenStandardOutput());
			}
		}
		...
		public static void Log(string format, params object[] data)
		{
			try
			{
				System.Console.Error.WriteLine(format, data);
				...
				while (true) {
					...
					if (clientSocket != null) {
						...
						new System.Threading.Thread(() => {
							...
							clientSocket.Close();
							System.Console.Error.WriteLine(">> client connection closed");
						}).Start();
					}
				}
			}).Start();
